    ...
    return (
        <article className='card'>
            ...
            <footer className='card__footer'>
                <button className='card__btn card__btn-trash' onClick={() => deleteUserById(user.id)}><i className="fa-solid fa-trash-can"></i>
                </button>
                <button className='card__btn card__btn-edit' onClick={handleEdit}><i className="fa-regular fa-pen-to-square"></i>
                </button>
            </footer>
        </article>
    )
